...
def make_model(type,name):
    ...
    model_args.min_length = 256
    model_args.top_p = 0.9
    model_args.top_k =  0
    model_args.num_return_sequences=  4
    model_args.do_samples = True
    model_args.num_beams = 4
    model_args.repetition_penalty = 2.5
    model_args.temperature = 0.7
    model_args.wandb_project = "NLP_cours_1"
    model = T5Model("type", "google/mt5-base", args=model_args)
